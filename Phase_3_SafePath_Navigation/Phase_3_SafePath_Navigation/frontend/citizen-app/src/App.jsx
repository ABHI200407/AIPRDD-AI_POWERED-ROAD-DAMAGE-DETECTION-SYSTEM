    ...
    <div className="app">
      ...
      <header className="glass px-6 py-4 flex justify-between items-center" style={{ borderRadius: 0, borderTop: 'none', borderLeft: 'none', borderRight: 'none', background: 'rgba(15, 23, 42, 0.95)' }}>
        <div className="flex flex-col gap-1">
          <h2 className="text-xl tracking-tighter text-white font-black">AIPRDD<span className="text-primary"></span></h2>
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Road Sentinel Elite v3.0.0</p>
        </div>
